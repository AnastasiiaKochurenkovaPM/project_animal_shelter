...
import s from './MyAdvertisementPage.module.css'
            ...
            <div className={s.content}>
                ...
                <div className={s.data}>
                    ...
                    <div className={s.buttons}>
                        <NavLink to={'/EditAdvertisement/' + data.id}>
                            <button className={s.button}>
                                <p>Редагувати оголошення</p>
                            </button>
                        </NavLink>
                        <NavLink to={'/Cabinet'}>
                        <button className={s.button} onClick={DeleteAd}>
                           <p>Деактивувати оголошення</p>
                        </button>
                        </NavLink>
                    </div>
                </div>
