...
const RegShelter = () => {
    ...
    const inputs = [
        {
            ...
            errorMessage: "Назва притулку не може містити спеціальні символи та цифри!",
        ...
        },
        {
            ...
            label: "Місто",
            pattern: "^[A-Za-zА-Яа-яґҐІіЇїЄє'’ʼ\\s-]{4,20}$",
            require: true,
        },
        {
            id: 3,
    ...
    const registration = async (e) => {
        e.preventDefault()
        const result = await Axios.post(process.env.REACT_APP_API_URL + "registration", {
            ...
            <div className="reg-mar">
                <form method="POST" action="/Registration">
                    ...
                    <div className={s.name}>
                        <button type="submit" className="button1" onClick={registration}>Зареєструватися
                        </button>
                    </div>
