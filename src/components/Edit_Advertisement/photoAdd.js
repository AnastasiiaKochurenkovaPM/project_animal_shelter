                ...
                <div className="smaller-download">
                    <div className="container2">
                        <div className="img-holder2">
                            <img src={profileImg2} alt="" id="img2" className="img2" />
                        </div>
                        <input type="file" accept="image2/*" name="image-upload3" id="input2" onChange={this.imageHandler2} />
                    ...
                    <div className="container2">
                        <div className="img-holder2">
                            <img src={profileImg3} alt="" id="img3" className="img2" />
                        </div>
                        <input type="file" accept="image{/*" name="image-upload2" id="input3" onChange={this.imageHandler3} />
                        <div className="label2">
